...
class EditJobs extends React.Component {
  ...
  displayJob = (job, deleteFn, updateFn) => {

    return (<JobView key={job.job_id} job_id={job.job_id} editable={true} deleteFromSidebar={deleteFn} updateSidebar={updateFn}></JobView>)
  }
